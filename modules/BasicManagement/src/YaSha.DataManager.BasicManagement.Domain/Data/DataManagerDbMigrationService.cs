...
{
    public class DataManagerDbMigrationService : ITransientDependency
    {
        private ILogger<DataManagerDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IDataManagerDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public DataManagerDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IDataManagerDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<DataManagerDbMigrationService>.Instance;
        }
