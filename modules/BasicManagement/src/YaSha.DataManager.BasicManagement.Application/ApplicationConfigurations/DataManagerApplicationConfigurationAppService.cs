...
namespace YaSha.DataManager.BasicManagement.ApplicationConfigurations;

[Dependency(ReplaceServices = true)]
[ExposeServices(typeof(IAbpApplicationConfigurationAppService))]
public class DataManagerApplicationConfigurationAppService : ApplicationService, IAbpApplicationConfigurationAppService
{
    ...
    public DataManagerApplicationConfigurationAppService(
