...
namespace YaSha.DataManager.Migrations
{
    ...
    [Migration("20230926021226_Created_StandardAndPolicy_TypeEntity")]
    partial class CreatedStandardAndPolicyTypeEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YaSha.DataManager.FamilyTrees.FamilyTree", b =>
                {
                    ...
                    b.ToTable("AppFamilyTree", (string)null);
                });

            modelBuilder.Entity("YaSha.DataManager.LanguageManagement.LanguageTexts.Aggregates.LanguageText", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("YaSha.DataManager.LanguageManagement.Languages.Aggregates.Language", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("YaSha.DataManager.ProductInventory.AggregateRoot.ProductInventMaterial", b =>
                {
                    ...
                    b.Property<string>("MaterialUsageFormula")
                        .HasColumnType("longtext");
                    ...
                    b.ToTable("AppProductInventMaterial", (string)null);
                });

            modelBuilder.Entity("YaSha.DataManager.ProductInventory.AggregateRoot.ProductInventModule", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("AppProductInventModule", (string)null);
                });

            modelBuilder.Entity("YaSha.DataManager.ProductInventory.AggregateRoot.ProductInventProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("AppProductInventProduct", (string)null);
                });

            modelBuilder.Entity("YaSha.DataManager.ProductInventory.AggregateRoot.ProductInventTree", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("YaSha.DataManager.ProductRetrieval.MaterialInventory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("YaSha.DataManager.ProductRetrieval.ProjectInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("YaSha.DataManager.StandardAndPolicy.AggregateRoot.StandardAndPolicyLibClipImage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("AppStandardAndPolicyLibClipImage", (string)null);
                });
            ...
            modelBuilder.Entity("YaSha.DataManager.FamilyLibs.FamilyLib", b =>
                {
                    b.HasOne("YaSha.DataManager.FamilyLibs.FamilyLib", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId");
            ...
            modelBuilder.Entity("YaSha.DataManager.ProductInventory.AggregateRoot.ProductInventMaterial", b =>
                {
                    b.HasOne("YaSha.DataManager.ProductInventory.AggregateRoot.ProductInventModule", "Module")
                        .WithMany("Materials")
                        .HasForeignKey("ModuleId");

                    b.HasOne("YaSha.DataManager.ProductInventory.AggregateRoot.ProductInventProduct", "Product")
                        .WithMany("Materials")
            ...
            modelBuilder.Entity("YaSha.DataManager.ProductInventory.AggregateRoot.ProductInventModule", b =>
                {
                    b.HasOne("YaSha.DataManager.ProductInventory.AggregateRoot.ProductInventProduct", "Parent")
                        .WithMany("Modules")
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("YaSha.DataManager.ProductInventory.AggregateRoot.ProductInventProduct", b =>
                {
                    b.HasOne("YaSha.DataManager.ProductInventory.AggregateRoot.ProductInventTree", "Parent")
                        .WithMany("Products")
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
