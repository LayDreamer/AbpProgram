namespace YaSha.DataManager.DbMigrator
{
    class Program
    {
...
#if DEBUG
                .MinimumLevel.Override("YaSha.DataManager", LogEventLevel.Debug)
#else
                .MinimumLevel.Override("YaSha.DataManager", LogEventLevel.Information)
#endif
