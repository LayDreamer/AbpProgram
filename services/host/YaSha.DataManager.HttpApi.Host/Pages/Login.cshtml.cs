...
using YaSha.DataManager.BasicManagement.Users;
using YaSha.DataManager.BasicManagement.Users.Dtos;
using Microsoft.AspNetCore.Mvc.RazorPages;
using Volo.Abp.Timing;


namespace YaSha.DataManager.Pages
{
    public class Login : PageModel
    {
        ...
        public async Task OnPost()
        {
            ...
            try
            {
                ...
                // 设置cookies domain
                //options.Domain = "DataManager.cn";


                var result = await _accountAppService.LoginAsync(new LoginInput()
                { Name = userName, Password = password });
                Response.Cookies.Append(DataManagerHttpApiHostConst.DefaultCookieName,
