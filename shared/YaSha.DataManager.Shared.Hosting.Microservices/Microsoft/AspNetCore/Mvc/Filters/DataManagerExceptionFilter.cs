...
public sealed class DataManagerExceptionFilter : IAsyncExceptionFilter, ITransientDependency
{
    ...
    private async Task HandleAndWrapException(ExceptionContext context)
    {
        ...
        var logger = context.GetService<ILogger<DataManagerExceptionFilter>>(NullLogger<DataManagerExceptionFilter>.Instance);
