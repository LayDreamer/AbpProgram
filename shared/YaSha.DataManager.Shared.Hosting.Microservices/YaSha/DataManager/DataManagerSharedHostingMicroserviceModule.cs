...
public class DataManagerSharedHostingMicroserviceModule : AbpModule
{
    ...
    private void ConfigureAbpExceptions(ServiceConfigurationContext context)
    {
        ...
        (
            options =>
            {
                options.Filters.Add(typeof(DataManagerExceptionFilter));
                options.Filters.Add(typeof(DataManagerResultFilter));
            }
        );
    }
