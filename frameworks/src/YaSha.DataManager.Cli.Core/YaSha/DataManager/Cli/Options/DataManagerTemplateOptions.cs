namespace YaSha.DataManager.Cli.Options;

public class DataManagerTemplateOptions
{
    public DataManagerTemplateOptions(string key, string name, string description, bool isSource = false)
    {
        Key = key;
        Name = name;
