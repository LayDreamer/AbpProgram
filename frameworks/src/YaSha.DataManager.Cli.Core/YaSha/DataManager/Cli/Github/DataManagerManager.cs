...
namespace YaSha.DataManager.Cli.Github;

public class DataManagerManager : ITransientDependency, IDataManagerManager
{
    private readonly DataManagerCliOptions _cliOptions;
    private readonly IHttpClientFactory _httpClientFactory;

    public DataManagerManager(IOptions<DataManagerCliOptions> options, IHttpClientFactory httpClientFactory)
    {
