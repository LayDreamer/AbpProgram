...
public class DataManagerCapDistributedEventBus : EventBusBase, IDistributedEventBus, ISingletonDependency
{
    ...
    public DataManagerCapDistributedEventBus(IServiceScopeFactory serviceScopeFactory,
        ...
        bool useOutbox = true)
    {
        ...
        {
            if (UnitOfWorkManager.Current is not DataManagerCapUnitOfWork capUnitOfWork || capUnitOfWork.CapTransaction is null)
            {
