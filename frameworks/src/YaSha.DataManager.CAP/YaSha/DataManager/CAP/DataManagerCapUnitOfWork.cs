...
public class DataManagerCapUnitOfWork : UnitOfWork
{
    ...
    {
        var factories = ServiceProvider.GetServices<IDataManagerCapTransactionApiFactory>();
