...
public class DataManagerCapConsumerServiceSelector : ConsumerServiceSelector, ISingletonDependency
{
    ...
    /// </summary>
    public DataManagerCapConsumerServiceSelector(IServiceProvider serviceProvider, IOptions<AbpDistributedEventBusOptions> distributedEventBusOptions) : base(serviceProvider)
    {
