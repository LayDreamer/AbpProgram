using YaSha.DataManager.ElasticSearch.Exceptions;
using YaSha.DataManager.ElasticSearch.Students;
using Nest;
using Shouldly;

namespace YaSha.DataManager.ElasticSearch
{
    public sealed class StudentElasticSearchRepositoryTests : DataManagerElasticSearchTestBase
    {
        ...
        {
            await Should.ThrowAsync<DataManagerElasticSearchEntityNotFoundException>(async () => { await _studentElasticSearchRepository.GetAsync(Guid.NewGuid()); });
        }
